...
var MyDocument = /** @class */ (function (_super) {
    ...
    MyDocument.prototype.render = function () {
        return (react_1["default"].createElement(document_1.Html, { lang: "ja" },
            react_1["default"].createElement(document_1.Head, null,
                react_1["default"].createElement("meta", { name: "theme-color", content: theme_1["default"].palette.primary.main }),
        ...
        switch (_a.label) {
            case 0:
                ...
                ctx.renderPage = function () {
                    return originalRenderPage({
                        enhanceApp: function (App) { return function (props) { return sheets.collect(react_1["default"].createElement(App, __assign({}, props))); }; }
                    });
                };
            ...
            case 1:
                ...
                return [2 /*return*/, __assign(__assign({}, initialProps), { 
                        ...
                        styles: __spreadArrays(react_1["default"].Children.toArray(initialProps.styles), [sheets.getStyleElement()]) })];
        }
    });
}); };
